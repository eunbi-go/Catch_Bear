...
void ScoreUIManager::SetPlayerScoreTexture(int nPlayer, int nScore)
{
	...
	texScore1 = GET_SINGLE(Resources)->Get<Texture>(L"score" + to_wstring(score1));
	texScore2 = GET_SINGLE(Resources)->Get<Texture>(L"score" + to_wstring(score2));
	texScore3 = GET_SINGLE(Resources)->Get<Texture>(L"score" + to_wstring(score3));
